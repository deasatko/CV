...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Libraries}{: NumPy, Pandas, Openpyxl, Mathlib} \\
     \textbf{Softwares}{: Tableau, Excel, Jira, Bloomberg, ICE Data Derivatives} \\
...
\begin{itemize}[leftmargin=0.15in, label={}]
   \small{\item{
    ...
    {Squad Leader AGESCI Scout (IT), leading the team to win multiple challenges for 3 years consecutively} \\
    {Interests in videogames, history, travelling, camping}
   }} 
\end{itemize}
