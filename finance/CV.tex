...
\section{Projects}
    ...
    \resumeProjectHeading
    {\textbf{\href{https://github.com/deasatko/University/tree/main/Bachelors/Dissertation}{\faGithub} Evaluation of the Financial Consequences of Acquisition} $|$ \emph{University of East London}}{2020}
    \resumeText{Examines its financial consequences, focusing on impacts to goodwill and stock prices.} 
\resumeSubHeadingListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Programming}{: Python, VBA, SQL, \LaTeX} \\
